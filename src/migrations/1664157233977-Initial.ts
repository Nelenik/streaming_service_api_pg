...
export class Initial1664157233977 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "song" ("id" SERIAL PRIMARY KEY, "name" varchar NOT NULL, "filename" varchar NOT NULL, "path" varchar NOT NULL, "image" varchar NOT NULL, "duration" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT NOW(), "albumId" integer, "artistId" integer)`,
    );

    await queryRunner.query(
      `CREATE TABLE "playlist" ("id" SERIAL PRIMARY KEY, "name" varchar NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT NOW(), "userId" integer)`,
    );

    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL PRIMARY KEY, "username" varchar NOT NULL, "password" varchar NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "artist" ("id" SERIAL PRIMARY KEY, "name" varchar NOT NULL, "image" varchar NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT NOW())`,
    );

    await queryRunner.query(
      `CREATE TABLE "album" ("id" SERIAL PRIMARY KEY, "name" varchar NOT NULL, "image" varchar NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT NOW(), "artistId" integer)`,
    );
